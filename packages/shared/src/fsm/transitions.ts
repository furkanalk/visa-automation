...
export const VALID_TRANSITIONS: Record<JobState, JobState[]> = {
  ...
  // From LOGGED_IN
  LOGGED_IN: ['FORM_FILLING', 'WAITING_HITL', 'FAILED_RETRYABLE', 'FAILED_TERMINAL', 'CANCELLED'],
  ...
  // From SLOT_FOUND
  SLOT_FOUND: ['PAYMENT', 'WAITING_HITL', 'FAILED_RETRYABLE', 'FAILED_TERMINAL', 'CANCELLED'],
